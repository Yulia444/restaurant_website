...
def gallery():
    ...
    return render_template("gallery.html", images=images, navies=navies, form=form)
...
def menu():
    ...
    return render_template("menu.html", dishes=dishes, categories=categories, navies=navies,
                            form=form)
...
def reviews():
    ...
    return render_template("reviews.html", navies=navies, reviews=reviews, form=form)
